        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {departments.map((dept) => (
            <button
              ...
              className="group relative bg-card p-8 rounded-2xl shadow-lg border border-border hover:border-primary hover:shadow-2xl transition-all duration-300 flex flex-col items-center text-center w-full"
            >
