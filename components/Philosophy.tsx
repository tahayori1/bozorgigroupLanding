      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <div className="space-y-4">
            ...
            <h3 className="text-2xl font-bold text-amber-600 dark:text-amber-400">{t['humanity.hospitalTitle']}</h3>
            <p className="text-gray-600 dark:text-gray-400">{t['humanity.hospitalText']}</p>
            <a href="https://en.abualisina.net" target="_blank" rel="noopener noreferrer" className="inline-block text-amber-600 dark:text-amber-500 font-semibold hover:text-amber-700 dark:hover:text-amber-400 transition">
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-2xl font-bold text-amber-600 dark:text-amber-400">{t['humanity.schoolTitle']}</h3>
