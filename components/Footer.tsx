...
const SocialIcon: React.FC<{ href: string, path: string, label: string }> = ({ href, path, label }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-amber-400 transition">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-center md:text-start">
          ...
          <div className="space-y-4">
            <a href="#home" className="inline-block text-2xl font-bold tracking-wider text-white uppercase">
              Bozorgi <span className="text-amber-400">Group</span>
            </a>
            <p className="text-gray-400 max-w-xs mx-auto md:mx-0">"{t['hero.motto']}"</p>
          </div>

          {/* Column 2: Location Map */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white uppercase tracking-wider">{t['footer.locationTitle']}</h3>
            <div className="overflow-hidden rounded-lg border border-gray-700 h-48">
              <iframe
          ...
          <div className="space-y-4 flex flex-col items-center md:items-start">
             <h3 className="text-lg font-semibold text-white uppercase tracking-wider">{t['footer.followUs']}</h3>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-base text-gray-400">
